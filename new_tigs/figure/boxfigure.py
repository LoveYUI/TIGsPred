...
# ax.set_xlabel('Predicted TIGs',color='k',fontsize=12)
# ax.set_ylabel('TIGs',color='k',fontsize=12)
# ## [y+1 for y in range(len(all_data))]运行结果是[1,2,3]
# plt.gcf().subplots_adjust(bottom=0.21)
# plt.text(0.65, 1.85, "p-value<0.001")
...
ax.set_ylabel('Predicted TIGs probability',color='k',fontsize=12)
ax.set_xlabel('TIGs',color='k',fontsize=12)
## [y+1 for y in range(len(all_data))]运行结果是[1,2,3]
plt.gcf().subplots_adjust(bottom=0.21)
