...
## svr
# model_svc = SVC(C=3, gamma=0.0078125, kernel='rbf',probability = True)
# model_svc.fit(train_x, train_y)
# prob_svc_y = model_svc.predict_proba(test_x)
# np.save("prob_svc_y.npy",prob_svc_y)
# #rf
...
# np.save("prob_rf_y.npy",prob_rf_y)
#
#
# #xgboost
...
# np.save("prob_xgb_y.npy",prob_xgb_y)
#
# exit()
#decision tree
...
prob_svc_y = np.load("prob_svc_y.npy")
prob_rf_y = np.load("prob_rf_y.npy")
prob_xgb_y = np.load("prob_xgb_y.npy")
...
ax = plt.gca()
ax.set_xlabel('FP Rate',color='k',fontsize=11)
ax.set_ylabel('TP Rate',color='k',fontsize=11)
